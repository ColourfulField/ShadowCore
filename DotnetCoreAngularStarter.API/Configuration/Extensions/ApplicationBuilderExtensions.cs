...
namespace DotnetCoreAngularStarter.API.Configuration.Extensions
{
    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(x =>
                             {
                                 x.SwaggerEndpoint("/swagger/v1/swagger.json", "DotnetCoreAngularStarter API V1");
                                 x.SwaggerEndpoint("/swagger/v0/swagger.json", "DotnetCoreAngularStarter API V0");                                 

                                 x.DocumentTitle("DotnetCoreAngularStarter");
                                 x.ShowJsonEditor();
